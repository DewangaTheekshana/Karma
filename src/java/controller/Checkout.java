...
public class Checkout extends HttpServlet {
    ...
    private void saveOrder(Session session, Transaction transaction, User user, Address address, JsonObject responseJsonObject) {
        try {
            ...
            String merchant_id = "1223738";
            String formatedAmount = new DecimalFormat("0.00").format(amount);
            String currency = "LKR";
            String merchanSecret = "NjM2MzIyODY1MzA5NzQyNjQwMTM4MjYyMjA1OTU4OTI5ODA0NjM=";
            ...
            payhere.addProperty("notify_url", "https://6164-2402-4000-10c2-f68b-6ddd-acfe-68b3-f9d8.ngrok-free.app/karma/VerifyPayments");
