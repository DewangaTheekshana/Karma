...
//            document.getElementById("st-tbody").classNames = "list";""
...
//            document.getElementById("st-item-qty").className="middle";
...
//                st_tbody.appendChild(st_order_total_tr);
            ...
            citySelect.dispatchEvent(new Event("change"));
            document.getElementById("st-subtotal").innerHTML="Rs."+subTot;
            document.getElementById("st-shipping-amount").innerHTML="Rs."+shipping;
            document.getElementById("st-order-total-amount").innerHTML="Rs."+subTot + shipping;
